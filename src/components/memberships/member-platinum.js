...
const MemberPlatinum = () => {
    return (
        <div className={`${styles.platinum} text-white-primary`} >
            <div className='flex flex-col'>
                ...
                <div className='flex ml-5 mt-5 uppercase font-bold text-2xl'>
                    <p className={`${styles.platinotitle}`} >Platinum</p>
                </div>
                ...
                <div className='mt-5 flex justify-center items-center'>
                    <button class="bg-blue-platino hover:bg-white-normal text-white-normal hover:text-blue-platino   font-bold py-2 px-4 border-b-4 rounded w-10/12">
                        Buy Platinum
                    </button>
                </div>
                ...
                <div className='flex mt-5 justify-center items-center'>
                    <span className={`${styles.containerbenefits} grid`} >
                        <Tooltip
                            ...
                            sx={{ m: 10, width: '100%' }}
                        >
                            <p className={`${styles.benefits} flex gap-3 mb-5 mt-5 cursor-pointer hover:text-white-normal`} ><CheckIcon className="flex items-center justify-center " /> 200 Lux's</p>
                        </Tooltip>
                        ...
                        <Tooltip
                            ...
                            sx={{ m: 10, width: '50%' }}
                        >
                            <p className={`${styles.benefits} flex gap-3 mb-5 hover:text-white-normal cursor-pointer`} ><CheckIcon className="flex items-center justify-center" />Platinum Badge</p>
                        </Tooltip>
                        <Divider className={styles.divider} />
                        <Tooltip
